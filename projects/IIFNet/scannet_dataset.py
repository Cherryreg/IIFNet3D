...
class SPScanNetDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        #added by fzx for use 2d img
        if self.use_2d:
            fused_points_filename = osp.join(self.data_root, 'scannet_fused/', sample_idx + '.pt')
        ...
        input_dict = dict(
            ...
            fused_points_filename=fused_points_filename if self.use_2d else None,)
